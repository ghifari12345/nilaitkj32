...
<head>
    ...
    <title>Aplikasi Nilai by Muhammad Hafizh Alghifari</title>
...
<body>
<nav class="navbar navbar-expand-lg" style="background-color: #860A86;">
    ...
    <div class="card">
        <div class="card-body" style="background-color: #860A86; color: white;">
            &copy; 2024-<?=date("Y")?> - Web Dev TKJ 31
            <span class="float-end">
                Versi 1.0 by <a href="http://ghifari.rf.gd" target="blank" rel="noopener noreferrer" style="color: white;">Muhammad Hafizh Alghifari</a>
            </span>
        </div>
    </div>
</div>
